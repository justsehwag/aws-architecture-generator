        ...
        <div className="rounded-lg border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3">
            <button
              type="button"
              onClick={() => {
                window.location.href = `https://arch-gen-915233.auth.ap-south-2.amazoncognito.com/oauth2/authorize?identity_provider=GitHub&redirect_uri=https://main.d2ql9jf2g6mp1f.amplifyapp.com/auth/callback&response_type=code&client_id=6fdg4l5e36m72lo3g52o430nl&scope=openid+email+profile`;
              }}
              disabled={isLoading}
